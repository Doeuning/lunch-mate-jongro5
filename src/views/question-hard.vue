    ...
    return {
      ...
      qna: [
        ...
        },
        {
          ...
          a: [
            {
              value: false,
              msg: "맛있고 비싼거 먹고싶으니까 이런거 누르죠ㅡㅡ;;",
              link: "sick-no",
            },
            {
              value: false,
              msg: "그나마 저렴하게 영양소를 골고루 채우고 싶어요.",
              link: "subway",
            },
          ],
        },
        {
          ...
          a: [
            ...
            {
              value: false,
              msg: "아니요?ㅡㅡ 솔직히 뭘 먹고싶은지 모르겠는데 ;; 그건 아니에요.",
              link: "no-food",
            },
            {
              value: false,
      ...
      result: [
        ...
        },
        {
          code: "japanese",
          name: "니지라멘",
          desc: "양은 적은데 맛있어요. 고춧가루? 매운가루? 꼭 넣어 드세요.",
